    ...
    public partial class UsageForm : Form
    {
        ...
        private void GetTelecomInfo()
        {
            try
            {
                var getHttp =
                    (HttpWebRequest)
                    WebRequest.Create("https://www.telecom.co.nz/mbbmeter2?accountnum=<censored>&refnum=<censored>");
